...
if [ $ISRUNNING -eq 1 ]; then
	...
	docker run -p 10080:3000 -p 10022:22 -v $HOME/gitea:/data -e TZ='Europe/Paris' -e PUID=$(id $USER -u) -e PGID=$(id $USER -g) --restart=always --name $NOMCONTAINER -dti hmgitea
fi
cat << EOF
